<?php
	function get_main_list()
    {
        ...
        foreach($row as $v)
        {
            ...
            $str .= '<option value='.$v["id"].' '.(isset($selected) ? $selected:'').'>'.$v["tenen"].'</option>';
        }
        $str .= '</select>';
	...
	function get_tags($id=0)
    {
        ...
        for($i=0;$i<count($row_tags);$i++)
        {
            ...
            $str .= '<option value="'.$row_tags[$i]["id"].'" '.(isset($selected) ? $selected:'').' /> '.$row_tags[$i]["tenen"].'</option>';
        }
        $str .= '</select>';
                    ...
                    <div class="form-group form-group-gallery">
                        ...
                        <div class="jFiler-items my-jFiler-items jFiler-row">
                            <ul class="jFiler-items-list jFiler-items-grid row scroll-bar" id="jFilerSortable">
                                <?php foreach($gallery as $v) $func->galleryFiler($v['stt'],$v['id'],$v['photo'],$v['tenen'],'news','col-xl-6 col-sm-3 col-6'); ?>
                            </ul>
                        </div>
                    </div>
                <?php } ?>
