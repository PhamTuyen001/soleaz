			...
			<div class="card-body">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<?php foreach($config['website']['lang'] as $k => $v) { ?>
								<div class="custom-control custom-radio d-inline-block mr-3 text-md">
									<input class="custom-control-input" type="radio" id="lang_default-<?=$k?>" name="data[options][lang_default]" <?=($k==$config['website']['lang-doc'])?"checked":($k==$options['lang_default'])?"checked":""?> value="<?=$k?>">
				...
				<div class="row">
					...
					<?php if(isset($config['setting']['hotline1']) && $config['setting']['hotline1']==true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="hotline1">Hotline 2:</label>
					...
					<?php if(isset($config['setting']['hotline2']) && $config['setting']['hotline2']==true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="hotline2">Hotline 3:</label>
