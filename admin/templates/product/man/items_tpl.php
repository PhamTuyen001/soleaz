                ...
                <?php } else { ?>
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) {
                        	$linkID = "";
							if($items[$i]['id_product']) $linkID .= "&id_product=".$items[$i]['id_product'];
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="tool-action mt-2 w-clear">
                                    	<?php if(isset($config['product'][$type]['view']) && $config['product'][$type]['view']==true) { ?>
                                    		<a class="text-primary mr-3" href="<?=$linkView?><?=$items[$i]['tenkhongdauvi']?>" target="_blank" title="<?=$items[$i]['ten'.$config['website']['lang-doc']]?>"><i class="far fa-eye mr-1"></i>View</a>
                                    	<?php } ?>
                                ...
                                <?php foreach($config['product'][$type]['check'] as $key => $value) { ?>
								  	<td class="align-middle text-center">
	                                	<div class="custom-control custom-checkbox my-checkbox">
	                                        <input type="checkbox" class="custom-control-input show-checkbox" id="show-checkbox-<?=$key?>-<?=$items[$i]['id']?>" data-table="product" data-id="<?=$items[$i]['id']?>" data-loai="<?=$key?>" <?=($items[$i][$key]==true)?'checked':''?>>
