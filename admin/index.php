...
<head>
	...
	<link href="assets/images/logo-2.png" rel="shortcut icon" type="image/x-icon" />
	...
	<script type="text/javascript">
		CKEDITOR.editorConfig = function( config ) {
			...
			/* All Plugins */
			config.extraPlugins = 'texttransform,copyformatting,html5video,html5audio,flash,youtube,wordcount,tableresize,widget,lineutils,clipboard,dialog,dialogui,widgetselection,lineheight,video,videodetector,fontweight';
			config.font_names = 'Quicksand/quicksand;' + config.font_names;
			...
			config.fontWeight = '300;400;500;600;700'
			/* Config CKFinder */
			...
			config.toolbar = [
				...
				'/',
				{ name: 'styles', items: [ 'Styles', 'Format', 'Font', 'FontSize', 'lineheight','fontweight' ] },
...
<body class="sidebar-mini hold-transition text-sm <?=(!isset($_SESSION[$login_admin]) || $_SESSION[$login_admin]==false)?'login-page':''?>">
